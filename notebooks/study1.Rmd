...
rdf_wide <- rdf_wide %>%
  select(id, age, sex, condition_order, condition_visible, file_name, cmx, cmx_mean, cmx_sd, cmx_rn7, cmx_rn5, cmx_rn6, cmx_rn8, cmx_rn9, correctness) %>%
  mutate(cmx_rn7 = str_extract_all(cmx_rn7, pattern = '\\d\\.\\d*'),
         cmx_rn5 = str_extract_all(cmx_rn5, pattern = '\\d\\.\\d*'),
